...
<h2>Contributing</h2><p>  <a href="https://github.com/expressjs/express/actions/workflows/ci.yml"><img src="https://badgen.net/github/checks/expressjs/express/master?label=linux" alt="Linux Build"></a>
...
<h3>Running Tests</h3><p>To run the test suite, first install the dependencies, then run <code>npm test</code>:</p>
<pre><code class="language-console">$ npm install
$ npm test
</code></pre>

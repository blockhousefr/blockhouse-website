...
<h2>Usage</h2><pre><code class="language-js">const isNumber = require(&#39;is-number&#39;);
</code></pre>
<p>See the <a href="./test.js">tests</a> for more examples.</p>
<h3>true</h3><pre><code class="language-js">isNumber(5e3);               // true
isNumber(0xff);              // true
isNumber(-1.1);              // true
isNumber(0);                 // true
isNumber(1);                 // true
...
<h3>False</h3><p>Everything else is false, as you would expect:</p>
...
<h2>Release history</h2><h3>7.0.0</h3><ul>
...
<h3>5.0.0</h3><p><strong>Breaking changes</strong></p>
<ul>
<li>removed support for <code>instanceof Number</code> and <code>instanceof String</code></li>
</ul>
<h2>Benchmarks</h2><p>As with all benchmarks, take these with a grain of salt. See the <a href="./benchmark/index.js">benchmarks</a> for more detail.</p>
<pre><code># all
...
<h3>License</h3><p>Copyright © 2018, <a href="https://github.com/jonschlinkert">Jon Schlinkert</a>.

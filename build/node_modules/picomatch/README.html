...
<h2>Table of Contents</h2><details><summary> Click to expand </summary>
...
<h2>Usage</h2><p>The main export is a function that takes a glob pattern and an options object and returns a function for matching strings.</p>
...
<h3><a href="lib/picomatch.js#L117">.test</a></h3><p>Test <code>input</code> with the given <code>regex</code>. This is used by the main <code>picomatch()</code> function to test the input string.</p>
<p><strong>Params</strong></p>
<ul>
...
<h3><a href="lib/picomatch.js#L161">.matchBase</a></h3><p>Match the basename of a filepath.</p>
<p><strong>Params</strong></p>
<ul>
<li><code>input</code> <strong>{String}</strong>: String to test.</li>
...
<h3><a href="lib/picomatch.js#L183">.isMatch</a></h3><p>Returns true if <strong>any</strong> of the given glob <code>patterns</code> match the specified <code>string</code>.</p>
<p><strong>Params</strong></p>
<ul>
...
<h3><a href="lib/picomatch.js#L199">.parse</a></h3><p>Parse a glob pattern to create the source string for a regular expression.</p>
<p><strong>Params</strong></p>
<ul>
...
<h3><a href="lib/picomatch.js#L231">.scan</a></h3><p>Scan a glob pattern to separate the pattern into segments.</p>
<p><strong>Params</strong></p>
<ul>
...
<h3><a href="lib/picomatch.js#L245">.compileRe</a></h3><p>Compile a regular expression from the <code>state</code> object returned by the
...
<h3><a href="lib/picomatch.js#L286">.makeRe</a></h3><p>Create a regular expression from a parsed glob pattern.</p>
<p><strong>Params</strong></p>
<ul>
...
<h3><a href="lib/picomatch.js#L321">.toRegex</a></h3><p>Create a regular expression from the given regex source string.</p>
<p><strong>Params</strong></p>
<ul>
...
<h2>Options</h2><h3>Picomatch options</h3><p>The following options may be used with the main <code>picomatch()</code> function or any of the methods on the picomatch API.</p>
<table>
<thead>
<tr>
...
<h3>Scan Options</h3><p>In addition to the main <a href="#picomatch-options">picomatch options</a>, the following options may also be used with the <a href="#scan">.scan</a> method.</p>
<table>
<thead>
<tr>
<th><strong>Option</strong></th>
...
<h3>Options Examples</h3><h4>options.expandRange</h4><p><strong>Type</strong>: <code>function</code></p>
...
<h4>options.format</h4><p><strong>Type</strong>: <code>function</code></p>
<p><strong>Default</strong>: <code>undefined</code></p>
...
<h4>options.onMatch</h4><pre><code class="language-js">const onMatch = ({ glob, regex, input, output }) =&gt; {
...
<h4>options.onIgnore</h4><pre><code class="language-js">const onIgnore = ({ glob, regex, input, output }) =&gt; {
  console.log({ glob, regex, input, output });
};
...
<h4>options.onResult</h4><pre><code class="language-js">const onResult = ({ glob, regex, input, output }) =&gt; {
  console.log({ glob, regex, input, output });
};
...
<h4>Matching behavior vs. Bash</h4><p>Picomatch&#39;s matching features and expected results in unit tests are based on Bash&#39;s unit tests and the Bash 4.3 specification, with the following exceptions:</p>
<ul>
...
<h4>POSIX brackets</h4><p>POSIX classes are disabled by default. Enable this feature by setting the <code>posix</code> option to true.</p>
...
<h3>Braces</h3><p>Picomatch does not do brace expansion. For <a href="https://www.gnu.org/software/bash/manual/html_node/Brace-Expansion.html">brace expansion</a> and advanced matching with braces, use <a href="https://github.com/micromatch/micromatch">micromatch</a> instead. Picomatch has very basic support for braces.</p>
<h3>Matching special characters as literals</h3><p>If you wish to match the following special characters in a filepath, and you want to use these characters in your glob pattern, they must be escaped with backslashes or quotes:</p>
...
<h2>Benchmarks</h2><p>Performance comparison of picomatch and minimatch.</p>
...
<h2>Philosophies</h2><p>The goal of this library is to be blazing fast, without compromising on accuracy.</p>
...
<h3>License</h3><p>Copyright © 2017-present, <a href="https://github.com/jonschlinkert">Jon Schlinkert</a>.

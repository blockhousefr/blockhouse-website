...
<h2>v3.0.0 Released!!</h2><p>See the <a href="CHANGELOG.md">changelog</a> for details.</p>
<h2>Why use braces?</h2><p>Brace patterns make globs more powerful by adding the ability to match specific ranges and sequences of characters.</p>
<ul>
...
<h2>Usage</h2><p>The main export is a function that takes one or more brace <code>patterns</code> and <code>options</code>.</p>
...
<h3>Brace Expansion vs. Compilation</h3><p>By default, brace patterns are compiled into strings that are optimized for creating regular expressions and matching.</p>
...
<h3>Lists</h3><p>Expand lists (like Bash &quot;sets&quot;):</p>
...
<h3>Sequences</h3><p>Expand ranges of characters (like Bash &quot;sequences&quot;):</p>
...
<h3>Steppped ranges</h3><p>Steps, or increments, may be used with ranges:</p>
...
<h3>Nesting</h3><p>Brace patterns may be nested. The results of each expanded string are not sorted, and left to right order is preserved.</p>
...
<h3>Escaping</h3><p><strong>Escaping braces</strong></p>
...
<h2>Options</h2><h3>options.maxLength</h3><p><strong>Type</strong>: <code>Number</code></p>
...
<h3>options.expand</h3><p><strong>Type</strong>: <code>Boolean</code></p>
...
<h3>options.nodupes</h3><p><strong>Type</strong>: <code>Boolean</code></p>
<p><strong>Default</strong>: <code>undefined</code></p>
<p><strong>Description</strong>: Remove duplicates from the returned array.</p>
<h3>options.rangeLimit</h3><p><strong>Type</strong>: <code>Number</code></p>
...
<h3>options.transform</h3><p><strong>Type</strong>: <code>Function</code></p>
<p><strong>Default</strong>: <code>undefined</code></p>
...
<h3>options.quantifiers</h3><p><strong>Type</strong>: <code>Boolean</code></p>
<p><strong>Default</strong>: <code>undefined</code></p>
...
<h3>options.unescape</h3><p><strong>Type</strong>: <code>Boolean</code></p>
<p><strong>Default</strong>: <code>undefined</code></p>
<p><strong>Description</strong>: Strip backslashes that were used for escaping from the result.</p>
<h2>What is &quot;brace expansion&quot;?</h2><p>Brace expansion is a type of parameter expansion that was made popular by unix shells for generating lists of strings, as well as regex-like matching when used alongside wildcards (globs).</p>
...
<h2>Brace matching</h2><p>In addition to <em>expansion</em>, brace patterns are also useful for performing regular-expression-like matching.</p>
...
<h2>Brace matching pitfalls</h2><p>Although brace patterns offer a user-friendly way of matching ranges or sets of strings, there are also some major disadvantages and potential risks you should be aware of.</p>
<h3>tldr</h3><p><strong>&quot;brace bombs&quot;</strong></p>
<ul>
...
<h3>The solution</h3><p>Jump to the <a href="#performance">performance section</a> to see how Braces solves this problem in comparison to other libraries.</p>
<h3>Geometric complexity</h3><p>At minimum, brace patterns with sets limited to two elements have quadradic or <code>O(n^2)</code> complexity. But the complexity of the algorithm increases exponentially as the number of sets, <em>and elements per set</em>, increases, which is <code>O(n^c)</code>.</p>
...
<h2>Performance</h2><p>Braces is not only screaming fast, it&#39;s also more accurate the other brace expansion libraries.</p>
<h3>Better algorithms</h3><p>Fortunately there is a solution to the <a href="#brace-matching-pitfalls">&quot;brace bomb&quot; problem</a>: <em>don&#39;t expand brace patterns into an array when they&#39;re used for matching</em>.</p>
...
<h3>Faster algorithms</h3><p>When you need expansion, braces is still much faster.</p>
...
<h2>Benchmarks</h2><h3>Running benchmarks</h3><p>Install dev dependencies:</p>
<pre><code class="language-bash">npm i -d &amp;&amp; npm benchmark
</code></pre>
<h3>Latest results</h3><p>Braces is more accurate, without sacrificing performance.</p>
